...
public class AboutMahasiswa extends AppCompatActivity {
    Toolbar toolbar;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_about_mahasiswa);

        toolbar = findViewById(R.id.toolbarAboutMhs);
        ...
        JustifyTextView txtLabel = (JustifyTextView) findViewById(R.id.textmhs);
